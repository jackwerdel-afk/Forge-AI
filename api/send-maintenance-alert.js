module.exports = async (req, res) => {
  ...
  const emailHtml = `<!DOCTYPE html><html><body style="margin:0;padding:0;background:#0c0c0d;font-family:'Helvetica Neue',Arial,sans-serif">
<div style="max-width:560px;margin:0 auto;padding:40px 20px">
  <div style="margin-bottom:32px">
    ...
    <span style="color:#f0f0f2;font-size:1.1rem;font-weight:800;margin-left:10px">Forge AI — Maintenance Report</span>
  </div>
