module.exports = async (req, res) => {
  ...
  const plans = {
    ...
    agency: { name: 'Forge AI Agency', description: 'Up to 25 client sites', amount: 14900, interval: 'month' },
    enterprise: { name: 'Forge AI Enterprise', description: 'Unlimited sites', amount: 39900, interval: 'month' }
  };
