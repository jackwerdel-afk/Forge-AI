...
module.exports = async (req, res) => {
  ...
  const { email, passwordHash, isBeta, betaToken, termsAgreedAt } = req.body;
  ...
  try {
    ...
    const alreadyExists = existingUsers && existingUsers.some(u => u.email && u.email.toLowerCase() === email.toLowerCase().trim());
    if (alreadyExists) {
...
<div style="max-width:520px;margin:0 auto;padding:40px 20px">
  <div style="background:#0e0e18;border:1px solid rgba(255,136,63,0.2);border-radius:14px;overflow:hidden">
    <div style="background:#000000;padding:24px 32px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.07)">
      <img src="https://mybvzjcjfjytcfgitmpv.supabase.co/storage/v1/object/public/assets/forge-ai-logo.png" width="60" height="78" alt="" style="display:inline-block">
    </div>
