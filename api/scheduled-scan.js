  ...
  try {
    ...
    for (const site of sites) {
      try {
        ...
        const previousScore = site.last_score || newScore;
        ...
        // Only alert if score DROPPED by 10+ points since last scan
        // NOT just because there are existing issues
        const needsAlert = scoreDrop >= 10;
