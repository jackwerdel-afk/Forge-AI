  ...
  try {
    ...
    if (tool === 'list_pages') {
      ...
      if (patchResult && patchResult.patchData) {
        ...
        verification = await verifyChange(apiKey, wixSiteId, itemId, 'description', newDescription);
      }
      ...
      if (result && result.patchData) {
        ...
        verification = await verifyChange(apiKey, wixSiteId, itemId, 'title', newTitle);
      }
      result.verification = verification;
