...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const [seoResult, mobileResult, uxResult, maintenanceResult, performanceResult, securityResult] = await Promise.all([
    ...
    // Security is bonus — doesn't reduce existing scores, adds up to 20 bonus points
    // Total is still capped at 100 but security findings show separately
