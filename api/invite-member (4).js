...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const emailHtml = `
<!DOCTYPE html><html><body style="margin:0;padding:0;background:#000000;font-family:'Inter',Arial,sans-serif">
<div style="max-width:520px;margin:0 auto;padding:40px 20px">
  <div style="background:#0d0d0d;border:1px solid rgba(255,136,63,0.2);border-radius:14px;overflow:hidden">
    <div style="background:#000000;padding:32px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.07)">
