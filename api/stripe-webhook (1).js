...
module.exports = async (req, res) => {
  ...
  // Get raw body — must read from stream since Vercel parses body by default
  let rawBody;
  try {
    ...
    // Fallback — if stream already consumed, use parsed body
    rawBody = typeof req.body === 'string' ? req.body : JSON.stringify(req.body);
  }

  // If rawBody is empty, fall back to parsed body
  if (!rawBody) {
    rawBody = typeof req.body === 'string' ? req.body : JSON.stringify(req.body);
  }
