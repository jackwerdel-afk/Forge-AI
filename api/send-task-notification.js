  ...
  <tr><td align="center" style="padding:40px 20px">
    <table width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%">
      ...
      <tr><td style="background:#111;border:1px solid #222;border-radius:12px 12px 0 0;padding:24px 28px;border-bottom:none">
        <div style="font-size:11px;color:#FF883F;font-family:monospace;letter-spacing:0.15em;text-transform:uppercase;margin-bottom:6px">New Task Assigned</div>
      ...
      <tr><td style="background:#111;border:1px solid #222;border-top:none;border-bottom:none;padding:20px 28px">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#000000;border:1px solid #222;border-radius:8px;margin-bottom:16px">
      ...
      <tr><td style="background:#000000;border:1px solid #222;border-top:none;border-radius:0 0 12px 12px;padding:14px 28px;text-align:center">
